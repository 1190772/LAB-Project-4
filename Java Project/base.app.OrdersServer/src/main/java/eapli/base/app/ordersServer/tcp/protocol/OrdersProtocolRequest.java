...
public abstract class OrdersProtocolRequest {

    protected final String request;

    protected OrdersProtocolRequest(final String inputRequest) {
    ...
    protected String buildBadRequest(final String errorDescription) {
        final BaseErrorRequest r = new BadRequest(request, errorDescription);
        return r.buildResponse();
    }
