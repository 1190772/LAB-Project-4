...
//    public MatrixGraph(boolean isDirected, ArrayList<V> vertices, E[][] mat) {
//        this(isDirected, vertices.size());
...
//                if(i != j) {
//                    addEdge(vertices.get(i),vertices.get(j),mat[i][j]);
//                }
//            }
//        }
//    }
